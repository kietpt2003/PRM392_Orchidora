...
public class ManageOrderScreen extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        manageOrderList.add(new ManageOrder(R.drawable.home_cart_icon, "HNSG 145 21", "https://hips.hearstapps.com/hmg-prod/images/vanda-orchid-types-1587739024.jpg?crop=1.00xw:0.976xh;0,0.0242xh&resize=980:*", "Dendrobium Orchids", "Dendrobium", 1, "$200", R.drawable.transaction_history_local_shipping_icon, "Cancel"));
