...
public class ManageOrder {
    ...
    public ManageOrder(int storeIcon, String storeId, String imageUrl, String orchidName, String orchidCategory, int orchidQuantity, String total, int statusIcon, String statusText) {
